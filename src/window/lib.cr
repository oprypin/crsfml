...
lib SFMLExt
  ...
  fun sfml_keyboard_scan_allocate(result : Void**)
  fun sfml_keyboard_scan_free(self : Void*)
  fun sfml_keyboard_iskeypressed_cKW(key : LibC::Int, result : Bool*)
  fun sfml_keyboard_iskeypressed_1Us(code : LibC::Int, result : Bool*)
  fun sfml_keyboard_localize_1Us(code : LibC::Int, result : LibC::Int*)
  fun sfml_keyboard_delocalize_cKW(key : LibC::Int, result : LibC::Int*)
  fun sfml_keyboard_getdescription_1Us(code : LibC::Int, result : Char**)
  ...
  fun sfml_mouse_getposition_occ(relative_to : Void*, result : Void*)
  fun sfml_mouse_setposition_ufV(position : Void*)
  fun sfml_mouse_setposition_ufVocc(position : Void*, relative_to : Void*)
  ...
  fun sfml_event_keyevent_setscancode_1Us(self : Void*, scancode : LibC::Int)
  ...
  fun sfml_touch_getposition_emSocc(finger : LibC::UInt, relative_to : Void*, result : Void*)
  ...
  fun sfml_vulkan_allocate(result : Void**)
  fun sfml_vulkan_free(self : Void*)
  fun sfml_vulkan_isavailable_GZq(require_graphics : Bool, result : Bool*)
  fun sfml_vulkan_getfunction_Yy6(name : LibC::Char*, result : Void*)
  fun sfml_vulkan_getgraphicsrequiredinstanceextensions(result : LibC::Char***, result_size : LibC::SizeT*)
  fun sfml_windowbase_allocate(result : Void**)
  fun sfml_windowbase_free(self : Void*)
  fun sfml_windowbase_initialize(self : Void*)
  fun sfml_windowbase_initialize_wg0bQssaL(self : Void*, mode : Void*, title_size : LibC::SizeT, title : Char*, style : UInt32)
  fun sfml_windowbase_initialize_rLQ(self : Void*, handle : WindowHandle)
  fun sfml_windowbase_finalize(self : Void*)
  fun sfml_windowbase_create_wg0bQssaL(self : Void*, mode : Void*, title_size : LibC::SizeT, title : Char*, style : UInt32)
  fun sfml_windowbase_create_rLQ(self : Void*, handle : WindowHandle)
  fun sfml_windowbase_close(self : Void*)
  fun sfml_windowbase_isopen(self : Void*, result : Bool*)
  fun sfml_windowbase_pollevent_YJW(self : Void*, event : Void*, result : Bool*)
  fun sfml_windowbase_waitevent_YJW(self : Void*, event : Void*, result : Bool*)
  fun sfml_windowbase_getposition(self : Void*, result : Void*)
  fun sfml_windowbase_setposition_ufV(self : Void*, position : Void*)
  fun sfml_windowbase_getsize(self : Void*, result : Void*)
  fun sfml_windowbase_setsize_DXO(self : Void*, size : Void*)
  fun sfml_windowbase_settitle_bQs(self : Void*, title_size : LibC::SizeT, title : Char*)
  fun sfml_windowbase_seticon_emSemS843(self : Void*, width : LibC::UInt, height : LibC::UInt, pixels : UInt8*)
  fun sfml_windowbase_setvisible_GZq(self : Void*, visible : Bool)
  fun sfml_windowbase_setmousecursorvisible_GZq(self : Void*, visible : Bool)
  fun sfml_windowbase_setmousecursorgrabbed_GZq(self : Void*, grabbed : Bool)
  fun sfml_windowbase_setmousecursor_Voc(self : Void*, cursor : Void*)
  fun sfml_windowbase_setkeyrepeatenabled_GZq(self : Void*, enabled : Bool)
  fun sfml_windowbase_setjoystickthreshold_Bw9(self : Void*, threshold : LibC::Float)
  fun sfml_windowbase_requestfocus(self : Void*)
  fun sfml_windowbase_hasfocus(self : Void*, result : Bool*)
  fun sfml_windowbase_getsystemhandle(self : Void*, result : WindowHandle*)
  fun sfml_windowbase_createvulkansurface_M35HMp7QC(self : Void*, instance : Void*, surface : Void*, allocator : Void*, result : Bool*)
  ...
  fun sfml_window_create_wg0bQssaL(self : Void*, mode : Void*, title_size : LibC::SizeT, title : Char*, style : UInt32)
  fun sfml_window_create_wg0bQssaLFw4(self : Void*, mode : Void*, title_size : LibC::SizeT, title : Char*, style : UInt32, settings : Void*)
  fun sfml_window_create_rLQ(self : Void*, handle : WindowHandle)
  ...
  fun sfml_window_createvulkansurface_M35HMp7QC(self : Void*, instance : Void*, surface : Void*, allocator : Void*, result : Bool*)
