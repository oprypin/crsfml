...
lib VoidCSFML
  fun contextsettings_initialize_emSemSemSemSemSemSGZq(self : Void*, depth : LibC::UInt, stencil : LibC::UInt, antialiasing : LibC::UInt, major : LibC::UInt, minor : LibC::UInt, attributes : LibC::UInt, s_rgb : Bool)
  ...
  fun contextsettings_setsrgbcapable_GZq(self : Void*, s_rgb_capable : Bool)
  ...
  fun context_getsettings(self : Void*, result : Void*)
  fun context_isextensionavailable_Yy6(name : LibC::Char*, result : Bool*)
  fun context_getactivecontext(result : Void**)
  ...
  fun window_setmousecursorgrabbed_GZq(self : Void*, grabbed : Bool)
