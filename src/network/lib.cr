...
lib VoidCSFML
  ...
  fun packet_operator_shl_GZq(self : Void*, data : Bool, result : Void*)
  fun packet_operator_shl_k6g(self : Void*, data : Int8, result : Void*)
  fun packet_operator_shl_9yU(self : Void*, data : UInt8, result : Void*)
  fun packet_operator_shl_yAA(self : Void*, data : Int16, result : Void*)
  fun packet_operator_shl_BtU(self : Void*, data : UInt16, result : Void*)
  fun packet_operator_shl_qe2(self : Void*, data : Int32, result : Void*)
  fun packet_operator_shl_saL(self : Void*, data : UInt32, result : Void*)
  fun packet_operator_shl_G4x(self : Void*, data : Int64, result : Void*)
  fun packet_operator_shl_Jvt(self : Void*, data : UInt64, result : Void*)
  fun packet_operator_shl_Bw9(self : Void*, data : LibC::Float, result : Void*)
  fun packet_operator_shl_mYt(self : Void*, data : LibC::Double, result : Void*)
  fun packet_operator_shl_Yy6(self : Void*, data : LibC::Char*, result : Void*)
  fun packet_operator_shl_zkC(self : Void*, data_size : LibC::SizeT, data : LibC::Char*, result : Void*)
  fun packet_operator_shl_bQs(self : Void*, data_size : LibC::SizeT, data : Char*, result : Void*)
  ...
  fun tcplistener_listen_bxi(self : Void*, port : LibC::UShort, result : LibC::Int*)
  ...
  fun udpsocket_bind_bxi(self : Void*, port : LibC::UShort, result : LibC::Int*)
