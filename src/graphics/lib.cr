...
lib VoidCSFML
  ...
  fun texture_setsrgb_GZq(self : Void*, s_rgb : Bool)
  fun texture_issrgb(self : Void*, result : Bool*)
  fun texture_setrepeated_GZq(self : Void*, repeated : Bool)
  fun texture_isrepeated(self : Void*, result : Bool*)
  fun texture_generatemipmap(self : Void*, result : Bool*)
  ...
  fun font_getglyph_saLemSGZqBw9(self : Void*, code_point : UInt32, character_size : LibC::UInt, bold : Bool, outline_thickness : LibC::Float, result : Void*)
  ...
  fun rendertexture_generatemipmap(self : Void*, result : Bool*)
  ...
  fun renderwindow_setmousecursorgrabbed_GZq(self : Void*, grabbed : Bool)
  ...
  fun shader_loadfromfile_zkCzkCzkC(self : Void*, vertex_shader_filename_size : LibC::SizeT, vertex_shader_filename : LibC::Char*, geometry_shader_filename_size : LibC::SizeT, geometry_shader_filename : LibC::Char*, fragment_shader_filename_size : LibC::SizeT, fragment_shader_filename : LibC::Char*, result : Bool*)
  ...
  fun shader_loadfrommemory_zkCzkCzkC(self : Void*, vertex_shader_size : LibC::SizeT, vertex_shader : LibC::Char*, geometry_shader_size : LibC::SizeT, geometry_shader : LibC::Char*, fragment_shader_size : LibC::SizeT, fragment_shader : LibC::Char*, result : Bool*)
  ...
  fun shader_loadfromstream_PO0PO0PO0(self : Void*, vertex_shader_stream : Void*, geometry_shader_stream : Void*, fragment_shader_stream : Void*, result : Bool*)
  ...
  fun shader_isgeometryavailable(result : Bool*)
  ...
  fun text_setfillcolor_QVe(self : Void*, color : Void*)
  fun text_setoutlinecolor_QVe(self : Void*, color : Void*)
  fun text_setoutlinethickness_Bw9(self : Void*, thickness : LibC::Float)
  ...
  fun text_getfillcolor(self : Void*, result : Void*)
  fun text_getoutlinecolor(self : Void*, result : Void*)
  fun text_getoutlinethickness(self : Void*, result : LibC::Float*)
