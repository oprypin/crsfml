...
VOIDCSFML_API packet_operator_shr_NiZ(void* self, int32_t* data);
VOIDCSFML_API packet_operator_shr_qTz(void* self, uint32_t* data);
VOIDCSFML_API packet_operator_shr_BuW(void* self, int64_t* data);
VOIDCSFML_API packet_operator_shr_7H7(void* self, uint64_t* data);
VOIDCSFML_API packet_operator_shr_ATF(void* self, float* data);
VOIDCSFML_API packet_operator_shr_nIp(void* self, double* data);
VOIDCSFML_API packet_operator_shr_GHF(void* self, char** data);
VOIDCSFML_API packet_operator_shl_GZq(void* self, unsigned char data);
VOIDCSFML_API packet_operator_shl_k6g(void* self, int8_t data);
VOIDCSFML_API packet_operator_shl_9yU(void* self, uint8_t data);
VOIDCSFML_API packet_operator_shl_yAA(void* self, int16_t data);
VOIDCSFML_API packet_operator_shl_BtU(void* self, uint16_t data);
VOIDCSFML_API packet_operator_shl_qe2(void* self, int32_t data);
VOIDCSFML_API packet_operator_shl_saL(void* self, uint32_t data);
VOIDCSFML_API packet_operator_shl_G4x(void* self, int64_t data);
VOIDCSFML_API packet_operator_shl_Jvt(void* self, uint64_t data);
VOIDCSFML_API packet_operator_shl_Bw9(void* self, float data);
VOIDCSFML_API packet_operator_shl_mYt(void* self, double data);
VOIDCSFML_API packet_operator_shl_zkC(void* self, size_t data_size, char* data);
