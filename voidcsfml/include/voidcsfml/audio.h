...
VOIDCSFML_API sfml_soundsource_play_callback(void (*callback)(void*));
VOIDCSFML_API sfml_soundsource_pause_callback(void (*callback)(void*));
VOIDCSFML_API sfml_soundsource_stop_callback(void (*callback)(void*));
VOIDCSFML_API sfml_soundsource_parent(void* self, void* parent);
...
VOIDCSFML_API sfml_soundsource_getstatus(void* self, int* result);
VOIDCSFML_API sfml_soundsource_initialize(void* self);
...
VOIDCSFML_API sfml_soundstream_onloop_callback(void (*callback)(void*, int64_t*));
...
VOIDCSFML_API sfml_soundstream_onloop(void* self, int64_t* result);
...
VOIDCSFML_API sfml_music_getlooppoints(void* self, void* result);
VOIDCSFML_API sfml_music_setlooppoints_TU3(void* self, void* time_points);
