...
VOIDCSFML_API sfml_operator_eq_FPeFPe(void* left, void* right, unsigned char* result);
VOIDCSFML_API sfml_operator_ne_FPeFPe(void* left, void* right, unsigned char* result);
...
VOIDCSFML_API sfml_texture_update_DJb(void* self, void* texture);
VOIDCSFML_API sfml_texture_update_DJbemSemS(void* self, void* texture, unsigned int x, unsigned int y);
...
VOIDCSFML_API sfml_texture_swap_zUT(void* self, void* right);
...
VOIDCSFML_API sfml_rendertarget_draw_U2Dmi4(void* self, void* vertex_buffer, void* states);
VOIDCSFML_API sfml_rendertarget_draw_U2Dvgvvgvmi4(void* self, void* vertex_buffer, size_t first_vertex, size_t vertex_count, void* states);
VOIDCSFML_API sfml_rendertarget_setactive_GZq(void* self, unsigned char active, unsigned char* result);
...
VOIDCSFML_API sfml_rendertexture_create_emSemSFw4(void* self, unsigned int width, unsigned int height, void* settings, unsigned char* result);
VOIDCSFML_API sfml_rendertexture_getmaximumantialiasinglevel(unsigned int* result);
...
VOIDCSFML_API sfml_rendertexture_draw_U2Dmi4(void* self, void* vertex_buffer, void* states);
VOIDCSFML_API sfml_rendertexture_draw_U2Dvgvvgvmi4(void* self, void* vertex_buffer, size_t first_vertex, size_t vertex_count, void* states);
...
VOIDCSFML_API sfml_renderwindow_setmousecursor_Voc(void* self, void* cursor);
...
VOIDCSFML_API sfml_renderwindow_draw_U2Dmi4(void* self, void* vertex_buffer, void* states);
VOIDCSFML_API sfml_renderwindow_draw_U2Dvgvvgvmi4(void* self, void* vertex_buffer, size_t first_vertex, size_t vertex_count, void* states);
...
VOIDCSFML_API sfml_text_setlinespacing_Bw9(void* self, float spacing_factor);
VOIDCSFML_API sfml_text_setletterspacing_Bw9(void* self, float spacing_factor);
...
VOIDCSFML_API sfml_text_getletterspacing(void* self, float* result);
VOIDCSFML_API sfml_text_getlinespacing(void* self, float* result);
...
VOIDCSFML_API sfml_vertexbuffer_allocate(void** result);
VOIDCSFML_API sfml_vertexbuffer_free(void* self);
VOIDCSFML_API sfml_vertexbuffer_initialize(void* self);
VOIDCSFML_API sfml_vertexbuffer_initialize_u9w(void* self, int type);
VOIDCSFML_API sfml_vertexbuffer_initialize_9vK(void* self, int usage);
VOIDCSFML_API sfml_vertexbuffer_initialize_u9w9vK(void* self, int type, int usage);
VOIDCSFML_API sfml_vertexbuffer_finalize(void* self);
VOIDCSFML_API sfml_vertexbuffer_create_vgv(void* self, size_t vertex_count, unsigned char* result);
VOIDCSFML_API sfml_vertexbuffer_getvertexcount(void* self, size_t* result);
VOIDCSFML_API sfml_vertexbuffer_update_46s(void* self, void* vertices, unsigned char* result);
VOIDCSFML_API sfml_vertexbuffer_update_46svgvemS(void* self, void* vertices, size_t vertex_count, unsigned int offset, unsigned char* result);
VOIDCSFML_API sfml_vertexbuffer_update_U2D(void* self, void* vertex_buffer, unsigned char* result);
VOIDCSFML_API sfml_vertexbuffer_swap_8jC(void* self, void* right);
VOIDCSFML_API sfml_vertexbuffer_getnativehandle(void* self, unsigned int* result);
VOIDCSFML_API sfml_vertexbuffer_setprimitivetype_u9w(void* self, int type);
VOIDCSFML_API sfml_vertexbuffer_getprimitivetype(void* self, int* result);
VOIDCSFML_API sfml_vertexbuffer_setusage_9vK(void* self, int usage);
VOIDCSFML_API sfml_vertexbuffer_getusage(void* self, int* result);
VOIDCSFML_API sfml_vertexbuffer_bind_Kfe(void* vertex_buffer);
VOIDCSFML_API sfml_vertexbuffer_isavailable(unsigned char* result);
VOIDCSFML_API sfml_vertexbuffer_draw_kb9RoT(void* self, void* target, void* states);
VOIDCSFML_API sfml_vertexbuffer_draw_fqURoT(void* self, void* target, void* states);
VOIDCSFML_API sfml_vertexbuffer_draw_Xk1RoT(void* self, void* target, void* states);
VOIDCSFML_API sfml_vertexbuffer_initialize_U2D(void* self, void* copy);
#endif
