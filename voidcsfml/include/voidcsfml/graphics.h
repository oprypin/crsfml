...
VOIDCSFML_API texture_setsrgb_GZq(void* self, unsigned char s_rgb);
VOIDCSFML_API texture_issrgb(void* self, unsigned char* result);
...
VOIDCSFML_API texture_generatemipmap(void* self, unsigned char* result);
...
VOIDCSFML_API font_getglyph_saLemSGZqBw9(void* self, uint32_t code_point, unsigned int character_size, unsigned char bold, float outline_thickness, void* result);
...
VOIDCSFML_API rendertexture_generatemipmap(void* self, unsigned char* result);
...
VOIDCSFML_API renderwindow_setmousecursorgrabbed_GZq(void* self, unsigned char grabbed);
...
VOIDCSFML_API shader_loadfromfile_zkCzkCzkC(void* self, size_t vertex_shader_filename_size, char* vertex_shader_filename, size_t geometry_shader_filename_size, char* geometry_shader_filename, size_t fragment_shader_filename_size, char* fragment_shader_filename, unsigned char* result);
...
VOIDCSFML_API shader_loadfrommemory_zkCzkCzkC(void* self, size_t vertex_shader_size, char* vertex_shader, size_t geometry_shader_size, char* geometry_shader, size_t fragment_shader_size, char* fragment_shader, unsigned char* result);
...
VOIDCSFML_API shader_loadfromstream_PO0PO0PO0(void* self, void* vertex_shader_stream, void* geometry_shader_stream, void* fragment_shader_stream, unsigned char* result);
...
VOIDCSFML_API shader_isgeometryavailable(unsigned char* result);
...
VOIDCSFML_API text_setfillcolor_QVe(void* self, void* color);
VOIDCSFML_API text_setoutlinecolor_QVe(void* self, void* color);
VOIDCSFML_API text_setoutlinethickness_Bw9(void* self, float thickness);
...
VOIDCSFML_API text_getfillcolor(void* self, void* result);
VOIDCSFML_API text_getoutlinecolor(void* self, void* result);
VOIDCSFML_API text_getoutlinethickness(void* self, float* result);
